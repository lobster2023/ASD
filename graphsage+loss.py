...
optimizer = torch.optim.Adam(model.parameters(), lr=learing_rate)  # 优化器
...
roc_auc = auc(fpr, tpr)
output = open('./graphsage+loss_final.pkl', 'wb')
...
with open("GraphSAGE+loss_final.txt","a") as file:
